...
#' controlled through this file. Do not delete \code{index.Rmd} or
#' \code{_site.yml}. \emph{TO DO: Where can we find out more about
#' \code{_site.yml}? Is that documented somewhere?}
#'
...
#' 
#' @note. Do not delete file \code{.Rproj} even if you do not use
