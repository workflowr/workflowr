...
#' workflowr project.
#'
#' \code{analysis/} contains all the source R Markdown files that implement the
#' analyses for your project. It contains a special R Markdown file,
#' \code{index.Rmd}, that typically does not include R code, and is will be used
#' to generate \code{index.html}, the homepage for the project website.
#' Additionally, this directory contains the important configuration file
#' \code{_site.yml}. The website theme, navigation bar, and other properties can
#' be controlled through this file (for more details see the documentation on
#' \href{https://rmarkdown.rstudio.com/rmarkdown_websites.html}{R Markdown
#' websites}). Do not delete \code{index.Rmd} or \code{_site.yml}.
#'
...
#' \code{.Rpoj}). \emph{Do not delete this file even if you do not use
#' RStudio; among other essential tasks, it is used to determine the
...
#'
#' @note Do not delete the file \code{.Rproj} even if you do not use RStudio;
#'   workflowr will not work correctly unless this file is there.
#'
...
#'   \code{existing}, this argument prevents files from accidentally being
#'   overwritten when \code{overwrite = FALSE}. When \code{overwrite = TRUE},
#'   any existing file in \code{directory} that has the same name as a workflowr
#'   file will be replaced by the workflowr file. When \code{git = TRUE}, all
#'   the standard workflowr files will be added and committed (regardless of
#'   whether they were overwritten or still contain the original content).
#'
