...
[![CRAN status](http://www.r-pkg.org/badges/version/workflowr)](https://cran.r-project.org/package=workflowr)
...
Install the latest release (v0.10.0) by running this command in R or
RStudio:
...
To cite workflowr in publications use:
  ...
  package version 0.10.0. https://github.com/jdblischak/workflowr
