...
tmp_dir <- tempfile("test-obtain_existing_path-", tmpdir = normalizePath("/tmp"))
...
test_that("obtain_existing_paths works with nested non-existing directories", {
  expect_identical(obtain_existing_path("x"), normalizePath("."))
  expect_identical(obtain_existing_path("x/"), normalizePath("."))
  expect_identical(obtain_existing_path("x/y"), normalizePath("."))
  expect_identical(obtain_existing_path("x/y/"), normalizePath("."))
  expect_identical(obtain_existing_path("x/y/z"), normalizePath("."))
})
