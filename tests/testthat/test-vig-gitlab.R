...
test_that("Setup GitLab infrastructure", {
  ...
  expect_true(dir.exists(s$docs))
  expect_false(dir.exists(file.path(site_dir, "docs")))
  expect_true(file.exists(file.path(site_dir, ".gitlab-ci.yml")))
  git_status <- git2r::status(r)
  print("The git status at this point is:")
  print(git_status)
