...
test_that("Can convert standard Rmd to workflowr", {
  tmp_standard <- tempfile("standard-", tmpdir = "/tmp", fileext = ".Rmd")
...
test_that("Can add missing yaml header", {
  tmp_noyaml <- tempfile("noyaml-", tmpdir = "/tmp", fileext = ".Rmd")
...
test_that("Can convert ashlar file", {
  tmp_ashlar <- tempfile("ashlar-", tmpdir = "/tmp", fileext = ".Rmd")
...
test_that("Can convert previous workflowr file", {
  tmp_previous <- tempfile("previous-", tmpdir = "/tmp", fileext = ".Rmd")
...
test_that("Does not affect a current workflowr file if standalone = FALSE", {
  tmp_workflowr <- tempfile("workflowr-", tmpdir = "/tmp", fileext = ".Rmd")
...
test_that("Does not affect a current standalone workflowr file if standalone = TRUE", {
  tmp_standalone <- tempfile("standalone-", tmpdir = "/tmp", fileext = ".Rmd")
