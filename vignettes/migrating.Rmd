...
```{r}
library("workflowr")
wflow_start("Name of project", "~/projects/new-project")
...
```{r}
library("workflowr")
wflow_start("Name of project", "~/projects/mature-project", existing = TRUE)
```
...
```{r}
library("workflowr")
wflow_start("Name of project", "~/projects/my-package", existing = TRUE)
```
...
```{r}
library("workflowr")
wflow_start("Name of project", "~/projects/ashlar-project", existing = TRUE)
```
