...
> directory" in R is missing from many novice R programmers. Make sure
> that the user first sets the working directory appropriately, either
> using `setwd` or using the menu options in RStudio.
