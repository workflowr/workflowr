...
`myproject/` that contains all the files to get started. It also changes the 
working directory to `myproject/`^[If you're using RStudio, in the future you
can choose `Open Project...` and select the file `myproject.Rproj` to quickly
continue working on your project. This will set the correct working directory in
the R console, switch the file navigator to the project, and configure the Git
pane.] and initializes a Git repository with the initial commit already made.
