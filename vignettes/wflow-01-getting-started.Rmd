...
First, you need to configure your local project for use use with GitHub. Pass
your GitHub username and desired repository name to the workflowr function
`wflow_use_github()`.
...
This had two main effects: 1) it configured Git to communicate with your future
GitHub repository, and 2) it inserted a link to your future GitHub repository
into the navigation bar (you'll need to run `wflow_build()` or `wflow_publish()`
to observe this change).

Second, you need to create the GitHub repository (you can skip this step if
you've already created it). To do this, login to your account on GitHub and
create a new repository following these [instructions][new-repo]. The screenshot
below shows the menu in the topright of the webpage.

<img src="github-new-repo.png" alt="Create a new repository on GitHub."
...
Third, you need to send your files to GitHub. Push your files to GitHub with the
...
Fourth, now that your code is on GitHub, you need to tell GitHub that you want
