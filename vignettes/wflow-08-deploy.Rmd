...
to this file on the "dev" branch. If you need any assistance with this, please
...
[dat-security]: https://docs.datproject.org/security
...
function `wflow_use_gitlab()`. For more details, please see the dedicated
vignette [Hosting workflowr websites using GitLab](wflow-06-gitlab.html).
