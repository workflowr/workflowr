...
data anlaysis in R, and by the end you will have a working website that you can
...
Everytime you open this RStudio project (e.g. by clicking on `myproject.Rproj`),
...
back down and click on the URL.
